...
import org.springframework.security.config.http.SessionCreationPolicy; // Recommended for JWT
...
git
    ...
    // ... other beans (AuthenticationManager, PasswordEncoder, CorsConfigurationSource) remain the same ...
